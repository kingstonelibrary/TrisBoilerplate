   ...
   !(function(e, n) {
     ...
     Object.keys(u).forEach(function(e) {
       u[e] = u[e].map(function(e) {
         ...
         return (
           (n.hash = ''), -1 === h.indexOf(e) && (n.search = ''), n.toString()
         );
       });
     }),
             ...
             return caches
               ...
               .then(function(e) {
                 return (
                   (r = e),
                   e.match(
                     new URL('__offline_webpack__data', location).toString()
                   )
                 );
               })
               .then(function(e) {
     ...
     function O() {
       return caches.open(m).then(function(n) {
         var t = new Response(
           JSON.stringify({ version: e.version, hashmap: l })
         );
         return n.put(
           new URL('__offline_webpack__data', location).toString(),
           t
       ...
       self.addEventListener('fetch', function(e) {
         if (
           ...
           if (u) {
             ...
             if ('navigate' === e.request.mode && !0 === r)
